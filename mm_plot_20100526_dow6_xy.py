...
mm_files = ['p1_100526.qcd.smooth',
            'p2_100526.qcd.smooth',
            'p3_100526.qcd.smooth',
            'p4_100526.qcd.smooth',
            'p7_100526.qcd.smooth']

# Initial day mobile mesonet is collecting data

init_day = dt.datetime(2010, 5, 26)

# Analysis Times. Should correspond to the time that the radar scan is valid

anal_t = [dt.datetime(2010, 5, 26, 22, 36, 59)]

# Coordinate system (options include 'latlon' or 'cart')
...
rad_files = ['swp.1100526223659.DOW6.0.1.0_SUR_v210']
